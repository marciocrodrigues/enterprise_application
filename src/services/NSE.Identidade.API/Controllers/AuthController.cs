...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private async Task<ResponseMessage> RegistrarCliente(UsuarioRegistro usuarioRegistro)
        {
            ...
            var sucesso = await _rpc.RequestAsync<UsuarioRegistradoIntegrationEvent, ResponseMessage>(usuarioRegistrado);
        ...
        private async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            var response = ObterResponseToke(user, claims, encodedToken);

            return response;
        }

        private UsuarioRespostaLogin ObterResponseToke(IdentityUser user, IList<Claim> claims, string encodedToken)
        {
